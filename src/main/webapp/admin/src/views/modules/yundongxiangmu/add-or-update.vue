    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运动名称" prop="yundongmingcheng">
          <el-input v-model="ruleForm.yundongmingcheng" 
              placeholder="运动名称" clearable  :readonly="ro.yundongmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运动名称" prop="yundongmingcheng">
              <el-input v-model="ruleForm.yundongmingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="场地名称" prop="changdimingcheng">
          <el-select :disabled="ro.changdimingcheng" v-model="ruleForm.changdimingcheng" placeholder="请选择场地名称">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="有效时间" prop="youxiaoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.youxiaoshijian" 
                type="date"
                :readonly="ro.youxiaoshijian"
                placeholder="有效时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.youxiaoshijian" label="有效时间" prop="youxiaoshijian">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="项目内容" prop="xiangmuneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmuneirong" label="项目内容" prop="xiangmuneirong">
                    <span v-html="ruleForm.xiangmuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangmuneirong = this.ruleForm.xiangmuneirong.replace(reg,'../../../ssm28zz6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yundongxiangmu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yundongxiangmuCrossAddOrUpdateFlag = false;
						 this.parent.search();
