<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场地类别" prop="changdileibie">
          <el-input v-model="ruleForm.changdileibie" 
              placeholder="场地类别" clearable  :readonly="ro.changdileibie"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场地大小" prop="changdidaxiao">
          <el-input v-model="ruleForm.changdidaxiao" 
              placeholder="场地大小" clearable  :readonly="ro.changdidaxiao"></el-input>
        </el-form-item>
        <div v-else>
