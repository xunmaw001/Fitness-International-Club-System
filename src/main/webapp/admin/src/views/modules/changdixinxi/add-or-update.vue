<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="场地类别" prop="changdileibie">
          <el-select :disabled="ro.changdileibie" v-model="ruleForm.changdileibie" placeholder="请选择场地类别">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="场地类别" prop="changdileibie">
	      <el-input v-model="ruleForm.changdileibie"
                placeholder="场地类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="场地大小" prop="changdidaxiao">
          <el-select :disabled="ro.changdidaxiao" v-model="ruleForm.changdidaxiao" placeholder="请选择场地大小">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="场地大小" prop="changdidaxiao">
	      <el-input v-model="ruleForm.changdidaxiao"
                placeholder="场地大小" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	changditupian : false,
      ...
      rules: {
          ...
          changdidaxiao: [
                { required: true, message: '场地大小不能为空', trigger: 'blur' },
          ],
          rongnarenshu: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.changdimingcheng = true;
          ...
          if(o=='changdileibie'){
            this.ruleForm.changdileibie = obj[o];
	    this.ro.changdileibie = true;
            continue;
          }
          if(o=='zulinjiage'){
	...
	this.ruleForm.changdixiangqing = this.ruleForm.changdixiangqing.replace(reg,'../../../ssm28zz6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
